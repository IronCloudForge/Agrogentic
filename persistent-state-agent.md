...
This work, **Persistent State Agent** (located at [IronCloudForge/Agrogentic](https://github.com/IronCloudForge/Agrogentic/blob/main/persistent-state-agent.md)), is licensed under a <a rel="license" href="http://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International License</a>.
